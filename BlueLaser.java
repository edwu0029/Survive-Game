...
class BlueLaser extends Projectile implements Drawable{
    private String path;
    ...
    BlueLaser(int id, GamePanel gamePanel, TileMap tileMap, int orientation, int direction, int x, int y, int speedMultiplier, String path){
